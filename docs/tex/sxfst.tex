...
Pre-training datasets do no necessarily need to be closely related to the target task, for example: models initially trained on the CIFAR 100 dataset (containing cars, animals etc. has been successfully re-tasked on phenotype identification from microscopy images \cite{ng2016nuts}. % xfer learning justification
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Improvements to data processing}
