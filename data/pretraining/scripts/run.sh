...
#./brenda.sh
curl 'https://www.brenda-enzymes.org/all_enzymes.php'   -H 'Connection: keep-alive'   -H 'Upgrade-Insecure-Requests: 1'   -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.111 Safari/537.36'   -H 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9'   -H 'Sec-Fetch-Site: none'   -H 'Sec-Fetch-Mode: navigate'   -H 'Sec-Fetch-User: ?1'   -H 'Sec-Fetch-Dest: document'   -H 'Accept-Language: en-GB,en-US;q=0.9,en;q=0.8'   --compressed | grep -E -o "[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+"  > ../data/ec.txt

#./bindingdb.sh
if !  test -f "../data/BindingDB_All_2022m4.tsv.zip" ; then
	curl 'https://www.bindingdb.org/bind/downloads/BindingDB_All_2022m4.tsv.zip' \
	  ...
	  --compressed > ../data/BindingDB_All_2022m4.tsv.zip
fi

#unzip BindingDB_All_2022m4.tsv.zip
zcat -dcf ../data/BindingDB_All_2022m4.tsv.zip > ../data/BindingDB_All.tsv

./bindingdb.py ../data/BindingDB_All.tsv | mongoimport -v $MONGODB_ADDR -c bindingdb

./mkdataset1.py > ../data/seq-smiles.csv
